...
class _Cloud {
  ...
  static const _assets = [
    "assets/images/plane_indicator/cloud1.png",
    "assets/images/plane_indicator/cloud2.png",
    "assets/images/plane_indicator/cloud3.png",
    "assets/images/plane_indicator/cloud4.png",
  ];
...
class PlaneIndicator extends StatefulWidget {
  final Widget child;
// value notifiers ons state changed
  final ValueChanged<IndicatorStateChange> onStateChanged;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final plane = AnimatedBuilder(
          ...
          child: Image.asset(
            "assets/images/plane_indicator/plane.png",
            width: 172,
            height: 50,
            fit: BoxFit.contain,
          ),
...
Widget indicatorBuilder(context, controller) {
  return Icon(
    Icons.ac_unit,
...
Widget refreshScrollTransition(context, child, controller) {
