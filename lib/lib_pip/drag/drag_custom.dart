...
//         widget.onDragUpdate(dragOffset);
//       },
...
//     if (avatar is _DragAvatar<T> && (widget.onWillAccept(avatar.data as T))) {
//       setState(() {
//         _candidateAvatars.add(avatar as _DragAvatar<T>);
//       });
//       return true;
//     } else {
//       setState(() {
...
//         return target.didEnter(this as _DragAvatar<Object>);
//       },
//       orElse: () => null,
//     );
...
//     for (int i = 0; i < _enteredTargets.length; i += 1) {
//       _enteredTargets[i].didLeave(this as _DragAvatar<Object>);
//     }
...
//       _activeTarget?.didDrop(this as _DragAvatar<Object>);
//       wasAccepted = true;
