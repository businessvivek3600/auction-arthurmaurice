...
import 'package:action_tds/services/handleNotification/notification_services.dart';
...
/*
  if (clickAction != null && clickAction.isNotEmpty) {
    if (clickAction == 'openChat') {
      if (payload != null && payload.isNotEmpty) {
        Map<String, dynamic> payloadMap = jsonDecode(payload);
        String? chatId = payloadMap['chatId'];
        String? userId = payloadMap['userId'];
        String? userName = payloadMap['userName'];
        String? userImage = payloadMap['userImage'];
        String? userToken = payloadMap['userToken'];
        String? userDeviceId = payloadMap['userDeviceId'];
        String? userDeviceType = payloadMap['userDeviceType'];
        String? userDeviceToken = payloadMap['userDeviceToken'];
        String? userDeviceName = payloadMap['userDeviceName'];
        String? userDeviceModel = payloadMap['userDeviceModel'];
        String? userDeviceVersion = payloadMap['userDeviceVersion'];
        String? userDeviceIsVirtual = payloadMap['userDeviceIsVirtual'];
        String? userDeviceIsEmulator = payloadMap['userDeviceIsEmulator'];
        String? userDeviceIsTablet = payloadMap['userDeviceIsTablet'];
        String? userDeviceIsTouch = payloadMap['userDeviceIsTouch'];
        String? userDeviceIsJailBroken = payloadMap['userDeviceIsJailBroken'];
        String? userDeviceIsReal = payloadMap['userDeviceIsReal'];
        String? userDeviceIsDebuggable = payloadMap['userDeviceIsDebuggable'];
        String? userDeviceIsRunningOnVm = payloadMap['userDeviceIsRunningOnVm'];
        String? userDeviceIsUsbConnected =
            payloadMap['userDeviceIsUsbConnected'];
        String? userDeviceIsAdbEnabled = payloadMap['userDeviceIsAdbEnabled'];
        String? userDeviceIsEmulatorCheck =
            payloadMap['userDeviceIsEmulatorCheck'];
        String? userDeviceIsDebuggerConnected =
            payloadMap['userDeviceIsDebuggerConnected'];
        String? userDeviceIsDeviceRooted =
            payloadMap['userDeviceIsDeviceRooted'];
        String? userDeviceIsRunningOnEmulator =
            payloadMap['userDeviceIsRunningOnEmulator'];
        String? userDeviceIsRunningOnEmulatorCheck =
            payloadMap['userDeviceIsRunningOnEmulatorCheck'];
        String? userDeviceIsRunningOnEmulatorQemu =
            payloadMap['userDeviceIsRunningOnEmulatorQemu'];
        String? userDeviceIsRunningOnEmulatorQemuCheck =
            payloadMap['userDeviceIsRunningOnEmulatorQemuCheck'];
      }
    } else if (clickAction == 'openProduct') {
      String? productId = message.data['productId'];
      if (productId != null && productId.isNotEmpty) {
        // Get.toNamed(Routes.productDetail, arguments: productId);
      }
    } else if (clickAction == 'openPromotion') {
      String? promotionId = message.data['promotionId'];
      if (promotionId != null && promotionId.isNotEmpty) {
        // Get.toNamed(Routes.promotionDetail, arguments: promotionId);
      }
    } else if (clickAction == 'openAuction') {
      String? auctionId = message.data['auctionId'];
      if (auctionId != null && auctionId.isNotEmpty) {
        // Get.toNamed(Routes.auctionDetail, arguments: auctionId);
      }
